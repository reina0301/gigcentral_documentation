...
*/
echo '<p></p>';
echo validation_errors(); //validation errors will show up here
?>

<!-- A student register form begins -->
<h1>A Student Register Form</h1>
<fieldset>
	<legend>Add_Student_list</legend><!--form title-->
	<?=form_open('gig_student_list/insert');? //form begins>
	<?php
		$FirstName = array(
			'name' => 'FirstName',
			'id' => 'FirstName',
...
<?=form_close();
/* End of file add_student_list.php */?>
